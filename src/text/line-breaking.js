...
export function findOptimalLineBreaks(words, lineCount, wordWidths, spaceWidth) {
...
export function measureWordWidths(words, font, cache) {
...
export function findOptimalLineBreaksForText(text, lineCount, font) {
