...
export { BASE_THICKNESS_MM, TARGET_MAX_SIZE_MM, computeScale, buildBasePlateMesh } from './base-plate.js';
export { buildRaisedRibbonMesh, normalizeProjectedPath, TRACK_HEIGHT_MM, TRACK_WIDTH_METRES } from './track-ribbon.js';
export { buildTrackPrismMesh } from './track-prism.js';
export {
