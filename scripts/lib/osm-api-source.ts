...
import {
  parseOsmXmlElements as _parseOsmXmlElements,
  buildOsmApiMapUrl as _buildOsmApiMapUrl,
  type ParsedOsmRelation as OsmRelation,
  type ParsedOsmRelationMember as OsmRelationMember,
} from '../../src/geometry/osm-xml-parser.js';
...
// XML parsing and URL building are shared with the runtime debug view.
// Delegate to the canonical implementation in src/geometry/osm-xml-parser.ts.
const parseOsmXmlElements = _parseOsmXmlElements;

export const buildOsmApiMapUrl = _buildOsmApiMapUrl;
